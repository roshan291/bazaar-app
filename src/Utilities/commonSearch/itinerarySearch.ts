export const itinerarySearch = (item: any, query: any) => {
    const search = item?.customerName?.toLowerCase().includes(query.toLowerCase()) || item?.itineraryTitle?.toLowerCase().includes(query.toLowerCase()) || item?.budgetForTrip?.toLowerCase().includes(query.toLowerCase()) || item?.mobileNumber?.toLowerCase().includes(query.toLowerCase()) || item?.dateOfIssue?.toLowerCase().includes(query.toLowerCase());
    return search;
}
